\hypertarget{group__gtc}{}\doxysection{G\+TC Extensions (Stable)}
...
\begin{DoxyCompactList}\small\item\em Aligned types. $<$glm/gtc/type\+\_\+aligned.\+hpp$>$ need to be included to use these features. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Allow the measurement of the accuracy of a function against a reference implementation. This extension works on floating-\/point data and provide results in U\+LP. $<$glm/gtc/ulp.\+hpp$>$ need to be included to use these features. \end{DoxyCompactList}\item 
\mbox{\hyperlink{group__gtc__vec1}{G\+L\+M\+\_\+\+G\+T\+C\+\_\+vec1}}
\begin{DoxyCompactList}\small\item\em Add vec1, ivec1, uvec1 and bvec1 types. $<$glm/gtc/vec1.\+hpp$>$ need to be included to use these functionalities. \end{DoxyCompactList}\end{DoxyCompactItemize}
